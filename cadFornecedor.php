...
<head>
    ...
    <link rel="stylesheet" href="stylecadFornecedor.css">
...
<body>
    <div class="cabecalho">
        ...
        <a href="cadFornecedor.php" class="active" id="navfornecedor">Fornecedor</a>
    ...
    <img src="imgcadFornecedor/menina_violino.png" class="menina_violino">
    <img src="imgcadFornecedor/forma_abstrata.png" class="forma_abstrata">
    <div class="desfoque"></div>
    <div class="caixa">
        <img src="imgcadFornecedor/notas_musicais.png" class="notas_musicais">
        <div class="container">
            <form action="php/insert_fornecedor.php" method="POST">
                <div class="titulo">
                    <label class="cadastro">CADASTRO</label>
                    <hr>
                    <label class="fornecedor">FORNECEDOR</label>
                </div>
                <label for="nome" id="txtnome" class="texto">Nome: </label>
                <input type="text" class="campo" id="nome" name="nm_fornecedor" placeholder="Nome" />
                <label for="contato" class="texto">Contato: </label>
                <input type="text" class="campo" id="contato" name="nm_contato" placeholder="Contato" />
                ...
                <label for="endereco" id="txtendereco" class="texto">Endereço: </label>
    ...
    <img src="imgcadFornecedor/usuario.png" class="usuario" />
</body>
